# led_toggle_addr_struct — 01-led-toggle-addr-struct

Same LED blink, refactored to use register structs instead of raw address #defines.
...
1. Check out this branch (`01-led-toggle-addr-struct`).
