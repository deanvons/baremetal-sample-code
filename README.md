# Systick_delay — 11-systick-delay

Millisecond delay function built on the SysTick 24-bit down-counter.
...
- SysTick is a 24-bit down-counter; reload value is computed from `SYSCLK`.
## C and C++ versions

This branch has both a **C** and a **C++** version of the same example — pick one, they cannot both be built (both define `main()`):

- C: `Src/main.c`, `Src/uart.c`, `Inc/uart.h`, `Src/adc.c`, `Inc/adc.h`, `Src/systick.c`, `Inc/systick.h`
- C++: `Src/main.cpp`, `Src/uart.cpp`, `Inc/uart.hpp`, `Src/adc.cpp`, `Inc/adc.hpp`, `Src/systick.cpp`, `Inc/systick.hpp`
...
1. Check out this branch (`11-systick-delay`).
