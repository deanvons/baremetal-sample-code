# adc_continuous_conversion — 10-adc-continuous-conversion

ADC1 in continuous conversion mode with EOC (end-of-conversion) flag handling.
...
1. Check out this branch (`10-adc-continuous-conversion`).
