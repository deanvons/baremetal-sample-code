# gpio_output — 02-gpio-output

Configure PA5 as a GPIO output and drive the Nucleo user LED using CMSIS device headers.
...
1. Check out this branch (`02-gpio-output`).
